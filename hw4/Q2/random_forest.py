...
class RandomForest(object):
    ...
    def _bootstrapping(self, XX, n):
        ...
        #https://www.quora.com/What-is-the-most-efficient-way-to-do-bootstrap-sampling-in-Python-numpy
        # lets first select n randon indexes in the numpy array where we will store all the data
        from random import randint
        for i in range(n):
            r_index = randint(0, n - 1)
            samples.append(XX[r_index][:-1])
            labels.append(XX[r_index][-1])
    ...
    def fitting(self):
        ...
        #print (self.bootstraps_datasets[0])
        #print (self.bootstraps_labels[0])
        for i in range(self.num_trees):
        #    print("num of tree",self.num_trees)
        #    print(i)
            #print("in random forest",len(self.bootstraps_datasets[i]))
        ...
        for record in X:
            ...
            for i in range(len(self.bootstraps_datasets)):
                ...
                if record not in dataset:
                    #print("here not in dataset para")
            ...
            if len(counts) == 0:
                ...
                # in this case we can select any random tree and give its vote
                tree = self.decision_trees[0]
                #print("oh shit..why I am coming here")
                effective_vote = tree.classify(record)
